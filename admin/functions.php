...
function findAllcategories(){
    ...
    echo "<td><a href='categories.php?edit={$cat_title}'>Edit</a></td>";
    echo "</tr>";
    }
}
...
function register_user($username,$email,$password){
    global $connection;
        ...
        $query .="VALUES('{$username}','{$email}','{$password}','susscriber') ";
...
function login_user($username , $password){
   ...
   if(password_verify($password,$db_user_password)){
        ...
        $_SESSION['user_role'] = $db_user_role;header("Location: ../index.php");
        redirect("/cms/admin");
    }else {
