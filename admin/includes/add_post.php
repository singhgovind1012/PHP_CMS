<?php
    if(isset($_POST['create_post'])){
        ...
        //$query = "INSERT INTO `posts`(`post_id`, `post_category_id`, `post_title`, `post_author`, `post_date`, `post_image`, `post_content`, `post_tags`, `post_comment_count`, `post_status`) VALUES (''[]',[post_category_id]','[post_title]','[post_author]','[now()]','[post_image]','[post_content]','[post_tags]','[post_comment_count]','[post_status]')";
        //$query = "INSERT INTO posts (post_category_id, post_title, post_author, post_date, post_image, post_content, post_tags, post_comment_count, post_status) ";

   // $query .= "VALUES ({$post_category_id},'{$post_title}','{$post_author}','".date('Y-m-d')."','{$post_image}','{$post_content}','{$post_tags}','{$post_comment_count}','{$post_status}' ) ";
        $create_post_category = mysqli_query($connection,$query);
        confirmQuery($create_post_category);
